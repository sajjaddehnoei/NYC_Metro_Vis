...
```{r}
data_station <- read_csv(paste0(here(),"/data/NYC_Transit_Subway_Entrance_And_Exit_Data.csv"))
...
all <- inner_join(data_station %>% 
                  ...
                  data3,by=c("Station Name"="STATION","Division"="DIVISION")) %>% 
  filter(DESC == 'REGULAR', Entry =='YES')
```
